...
const navigation = [
  {
    name: 'Twitter',
    href: 'https://twitter.com/agatevureglory',
    icon: (props: Props) => (
  ...
  {
    name: 'GitHub',
    href: 'https://github.com/gconnect/Carbon-Xchange',
    icon: (props: Props) => (
      <svg fill='white' viewBox='0 0 24 24' {...props}>
        <path
          fillRule='evenodd'
...
export default function Footer() {
  return (
    <footer className='bg-slate-950 mt-auto border-slate-700 border-t'>
      <div className='mx-auto max-w-7xl py-6 px-4 sm:px-6 md:flex md:items-center md:justify-between lg:px-8'>
        ...
        <div className='mt-8 md:order-1 md:mt-0'>
          <p className='text-center text-base text-slate-200'>
            ...
            <Link href='https//github.com/gconnect'>gconnect</Link>
          </p>
        </div>
      </div>
    </footer>
